...
// This file contains Linux-specific SDK loading and wrapper functions.
// All C code from driver.go has been moved here with //go:build linux && realscan tag.
